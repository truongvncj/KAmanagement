...
{
    public partial class kamassCofirm : Form
    {
        public kamassCofirm()
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            dc.ExecuteCommand("DELETE FROM tbl_MassConfirmTemp where tbl_MassConfirmTemp.Username ='" + username + "' or tbl_MassConfirmTemp.Username is null");
            dc.SubmitChanges();
            ...
            MassConfirm.massfilepinput();

            var rs = from tbl_MassConfirmTemp in dc.tbl_MassConfirmTemps
                     where tbl_MassConfirmTemp.Username == username
            ...
            if (rs.Count() > 0)
            {
                Viewtable viewtbl = new Viewtable(rs, dc, "MASS CONFIRM LIST", 11);// view code 11 la can viet them lenh MASS CONFIL
